...
import { getAuth, createComment } from '@/container/RestaurantAPI';
...
export const CommentPopup: React.FC<RatingPopupProps> = ({ onClose, restaurantId, ratingId }) => {
    ...
    const handleSubmit = async () => {
        ...
        if (auth) {
            if (comment.trim() !== '') {
                const commentMess = await createComment(restaurantId, commentData)
